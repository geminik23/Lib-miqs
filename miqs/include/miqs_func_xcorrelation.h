...
namespace miqs
{
	...
	_ResultIter xcorrelation(_Iter1 lbegin, _Iter1 lend, _Iter2 rbegin, _ResultIter result)
	{
	...
	template <typename _Iter1, typename _Iter2, typename _ResultIter>
	_ResultIter xcorrelation(_Iter1 lbegin, _Iter1 lend, _Iter2 rbegin, size_t max_lag, _ResultIter result)
	{
