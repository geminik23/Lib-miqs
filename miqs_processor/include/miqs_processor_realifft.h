...
namespace miqs
{
	namespace process
	{
		...
		class realifft:
			public TypeProcessor<realifft_module>
		{
		public:
			realifft();
		...
		inline void realifft::process(process_info& info, sample_t ** ins, size_t, sample_t ** outs, size_t)
		{
			auto in = ins[0];
			auto out = outs[0];
		...
		inline void realifft::operator()(sample_t *in, sample_t * out, size_t nframe)
		{
